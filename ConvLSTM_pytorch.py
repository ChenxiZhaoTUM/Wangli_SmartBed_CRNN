...
class ConvLSTM(nn.Module):
    ...
    def __init__(self, input_dim, hidden_dim, kernel_size, num_layers,
                 batch_first=False, bias=True, return_all_layers=False, only_last_time=False):
        ...
        self.only_last_time = only_last_time
    ...
    def forward(self, input_tensor, hidden_state=None):
        ...
        if not self.return_all_layers:  # only the last layer
